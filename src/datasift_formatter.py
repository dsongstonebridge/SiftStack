...
_PROBATE_SECTIONS: list[tuple[str, list[str]]] = [
    ...
    ("ESTATE", [
        "Real Property Stated", "Trust Name", "Title Holder of Record",
        "Insider Transfer", "Property Confirmed", "Estate Value",
        "Inventory Waived", "Legal Description", "Additional Parcels",
    ]),
    ("REPRESENTATIVE", [
